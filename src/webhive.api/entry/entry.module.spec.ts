...
import {
  mockMongoDatabaseClose,
  mockMongoDatabase,
} from '../testing/mock-mongo-database';
...
describe('entry api', () => {
  ...
  before(async () => {
      ...
      [
        {
          ...
          category_id: new ObjectId('000000000000000000000003'),
        },
        {
          ...
          category_id: new ObjectId('000000000000000000000004'),
        },
        {
    ...
    await database.collection('category').insertMany(
      [
        { _id: new ObjectId('000000000000000000000003'), name: 'cat03' },
        { _id: new ObjectId('000000000000000000000004'), name: 'cat04' },
      ],
      { forceServerObjectId: true },
    );
  });
