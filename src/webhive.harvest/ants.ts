...
export const ants: Ant[] = [
    ...
    { name: 'sixrevisions', target: 'http://feeds.feedburner.com/sixrevisions?format=xml', defaultCategory: 'Web' },
    { name: 'toddmotto', target: 'https://toddmotto.com/feed.xml', defaultCategory: 'Web' },
    { name: 'unscriptable', target: 'http://unscriptable.com/feed/', defaultCategory: 'JavaScript' },
